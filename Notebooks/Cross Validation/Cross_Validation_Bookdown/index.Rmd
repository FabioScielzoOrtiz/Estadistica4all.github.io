...
- Se divide aleatoriamente el data-set inicial $\hspace{0.01cm}D\hspace{0.01cm}$  en $\hspace{0.01cm}k\hspace{0.01cm}$ partes de manera que  cada parte tenga aproximadamente el mismo número de observaciones (sean lo mas balanceadas posibles).
    ...
    - Definimos las $\hspace{0.01cm} k\hspace{0.01cm}$ particiones de $\hspace{0.01cm} m \hspace{0.01cm}$ usando los cuantiles $\hspace{0.01cm} Q_0=1 \hspace{0.1cm},\hspace{0.1cm} Q_{1/k} \hspace{0.1cm},\hspace{0.1cm} Q_{2/k}\hspace{0.1cm},...,\hspace{0.1cm}Q_{(k-1)/k}\hspace{0.1cm},\hspace{0.1cm} Q_1=N\hspace{0.02cm}$ como sigue:  $\\[0.1cm]$
    ...
    - La siguiente matriz ilustra por qué este método funciona:  
...
- Se obtiene las siguientes $\hspace{0.1cm}k\hspace{0.1cm}$ muestras de train:  
