...
- Si la métrica es de **error**, como por ejemplo el $\hspace{0.1cm}ECM\hspace{0.1cm}$, entonces:
    ...
    - El modelo seleccionado es $\hspace{0.1cm}M_{j^{\hspace{0.08cm}*}}\hspace{0.1cm}$ , donde: $\\[0.05cm]$
...
- Si la métrica es de **acierto**, como por ejemplo la $\hspace{0.01cm}TAC\hspace{0.01cm}$, entonces: $\\[0.05cm]$

    - El modelo seleccionado es $\hspace{0.01cm}M_{j^{\hspace{0.08cm}*}}\hspace{0.01cm}$ , donde: $\\[0.05cm]$
