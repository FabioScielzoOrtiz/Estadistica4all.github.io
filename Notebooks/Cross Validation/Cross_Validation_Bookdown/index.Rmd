...
- Se obtienen $B$ particiones de la muestra de observaciones $D$ en parte de **train** y parte de **test** del siguiente modo: 
    ...
    ....&...\\
    x_{m_{r\lfloor k  \cdot N \rfloor} ,1}   & ... & x_{m_{r\lfloor k  \cdot N \rfloor},p} & y_{m_{r\lfloor k  \cdot N \rfloor}} \end{pmatrix}  \\[0.7cm]$$ 
  ...
  - En conclusión: $\hspace{0.03cm}$ se obtienen $\hspace{0.01cm}B\hspace{0.01cm}$ particiones de **train** y **test** de $\hspace{0.01cm}D\hspace{0.03cm}$ . $\\[0.75cm]$


- Para cada $\hspace{0.01cm}r\in \lbrace 1,...,B\rbrace$ $\\[0.01cm]$ 
    ...
    - Se calcula una misma métrica de evaluación sobre el modelo entrenado $\hspace{0.1cm}\widehat{M}_r\hspace{0.1cm}$ con la **muestra de test** $\hspace{0.01cm}D_{test,r}\hspace{0.03cm}$. 
        ...
        - Supongamos que la métrica de evaluación usada es el $\hspace{0.1cm}ECM\hspace{0.1cm}$ , entonces se obtienen $\hspace{0.1cm}B\hspace{0.1cm}$ valores de esta métrica : $\\[0.02cm]$
          ...
          - $\hat{y}_i^{test,r} \hspace{0.1cm}=\hspace{0.1cm} M(\hspace{0.1cm} x_i^{test, r} \hspace{0.1cm}|\hspace{0.1cm} D_{train,r}) \hspace{0.1cm}=\hspace{0.1cm} \widehat{M}_r (\hspace{0.1cm} x_i^{test, r} \hspace{0.1cm} )$ $\\[0.2cm]$ 
...
- Se calcula la métrica final de evaluación del modelo como el promedio de las $B$ métricas calculadas en el apartado anterior. 
    ...
    - Si la métrica usada en el apartado anterior es el $ECM$, entonces: $\\[0.02cm]$
...
- Se obtienen $B$ particiones de $D$ en parte de train y parte de test del siguiente modo: $\\[0.5cm]$
    ...
    - Se obtienen las siguientes $B$ **muestras  train** del data-set original $D$:
