...
- We will say that $\hspace{0.1cm}\lbrace \hspace{0.1cm} \mathcal{X}_t \in S  \hspace{0.1cm} : \hspace{0.1cm} t \in T \hspace{0.1cm} \rbrace\hspace{0.15cm}$ is a stochastic process with parameter space $\hspace{0.1cm}T\hspace{0.1cm}$ and states space $\hspace{0.1cm}S$. $\\[0.4cm]$
...
- $y_t \in \mathbb{R}\hspace{0.08cm}$ is a realization of the random variable $\hspace{0.08cm}\mathcal{Y}_t\hspace{0.08cm}.$ $\\[0.4cm]$
...
$\hspace{0.2cm}$ for $\hspace{0.1cm}t \in \lbrace 1,2,...,n \rbrace\hspace{0.1cm}$ and $\hspace{0.1cm} h\in \lbrace 0,\pm 1, \pm 2,... \rbrace \\$
...
Where $\hspace{0.07cm}y_t\hspace{0.07cm}$ is the value of the process $\hspace{0.08cm}\mathcal{Y}\hspace{0.08cm}$ at period $\hspace{0.07cm} t\hspace{0.07cm}$. $\\[0.4cm]$ 
...
- So, the non estimated model residuals are: $\\[0.35cm]$

    $$\varepsilon_t \hspace{0.1cm}=\hspace{0.1cm} y_t \hspace{0.08cm}-\hspace{0.08cm} (\phi_0 \hspace{0.08cm}+\hspace{0.08cm} \phi_1 \cdot y_{t-1}) \hspace{0.4cm} , \hspace{0.4cm} t=2,\dots , n \\$$ 

     


    - With OLS method, $\hspace{0.08cm}AR(1)\hspace{0.08cm}$ parameters estimation is made as follow:
$\\[0.3cm]$


    $$\widehat{\phi}_0, \widehat{\phi}_1 \hspace{0.2cm} =\hspace{0.2cm}  arg \hspace{0.25cm}  \underset{\phi_0, \phi_1}{Min} \hspace{0.2cm}  \sum_{t=2}^n\hspace{0.08cm} \varepsilon_t^2 \hspace{0.2cm} =\hspace{0.2cm}  arg \hspace{0.25cm}  \underset{\phi_0, \phi_1}{Min} \hspace{0.2cm} \sum_{t=2}^n \hspace{0.1cm} \left( \hspace{0.07cm} y_t \hspace{0.08cm}-\hspace{0.08cm} (\phi_0 + \phi_1\cdot y_{t-1}) \hspace{0.07cm}\right)^2$$
...
Given a stochastic process $\hspace{0.15cm} \mathcal{Y} \hspace{0.08cm}=\hspace{0.08cm}  \hspace{0.1cm}\bigl( \hspace{0.06cm} \mathcal{Y}_1 ,  \mathcal{Y}_2 ,..., \mathcal{Y}_n  \hspace{0.06cm}\bigl) \hspace{0.1cm}.$  $\\[0.35cm]$
...
$\hspace{0.25cm}$ The second-order autoregressive process $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ for the process $\hspace{0.08cm}\mathcal{Y}\hspace{0.08cm}$ is defined as: $\\[0.35cm]$
...
We can express $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ process using the lag operator as follow: $\\[0.3cm]$

$$\left(1 - \phi_1 \cdot B - \phi_2 \cdot B^2 \right) \cdot \mathcal{Y}_t \hspace{0.1cm} =\hspace{0.1cm} \phi_0 \hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t$$


Where: 

$\hspace{0.25cm}B\hspace{0.08cm}$ is the lag operator and is defined as follows:

$$B\cdot \mathcal{Y}_t \hspace{0.1cm}=\hspace{0.1cm} \mathcal{Y}_{t-1}$$

$$B^{\hspace{0.05cm} h}\cdot \mathcal{Y}_t \hspace{0.1cm}=\hspace{0.1cm} \mathcal{Y}_{t-h}  \hspace{0.3cm} , \hspace{0.3cm} h=1,2,\dots$$
...
$\hspace{0.25cm}$ Assuming that $\hspace{0.07cm}AR(2)\hspace{0.07cm}$ process is weakly stationary in mean we have the following: $\\[0.4cm]$
...
$\hspace{0.25cm}$ Where: $\hspace{0.12cm}\mu_t \hspace{0.08cm}=\hspace{0.08cm} E[\mathcal{Y}_t]\\$
...
$\hspace{0.25cm}$ $\mu_{\mathcal{Y}}\hspace{0.08cm}$ is finite only if $\hspace{0.15cm} 1-\phi_1-\phi_2 \hspace{0.08cm}\neq\hspace{0.08cm} 0\hspace{0.08cm}$.
...
$\hspace{0.25cm}$ Assuming that $\hspace{0.07cm}AR(2)\hspace{0.07cm}$ process is weakly stationary in variance we have the following: $\\[0.4cm]$
...
$\hspace{0.25cm}$ Where: $\hspace{0.12cm}\sigma^2_t \hspace{0.08cm}=\hspace{0.08cm} Var(\mathcal{Y}_t)\\$
...
$\hspace{0.25cm}$ $\sigma^2_{\mathcal{Y}}\hspace{0.11cm}$ is finite and positive only if $\hspace{0.12cm}\phi_1+\phi_2 < 1\hspace{0.15cm} ,$  $\hspace{0.15cm}\phi_2-\phi_1 < 1\hspace{0.15cm}$ and $\hspace{0.15cm}-1< \phi_2 < 1\hspace{0.1cm}$.
...
$\hspace{0.25cm}$ Assuming that   $\hspace{0.08cm}AR(1)\hspace{0.08cm}$ process is **weakly stationary in covariance**, we have the following: $\\[0.3cm]$
...
$\hspace{0.25cm}$ There isn't a general expression for $\hspace{0.08cm}\gamma_{h}\hspace{0.08cm}$ for any $\hspace{0.08cm}h=0,\pm 1, \pm 2,\dots\hspace{0.08cm}$ , but we can get them by recursion using the previous formula.

$$\gamma_{1} \hspace{0.08cm}=\hspace{0.08cm} \dfrac{\phi_1}{1-\phi_2} \cdot \sigma_{\mathcal{Y}}^2 \\[0.35cm]$$

$$\gamma_{2} \hspace{0.08cm}=\hspace{0.08cm} \left( \dfrac{\phi_1^2}{1-\phi_2} + \phi_2 \right)\cdot \sigma_{\mathcal{Y}}^2 $$
...
$$\gamma_{1} \hspace{0.08cm}=\hspace{0.08cm} \phi_1 \gamma_0 \hspace{0.08cm}+\hspace{0.08cm} \phi_2\cdot \gamma_{-1} \hspace{0.08cm}=\hspace{0.08cm}  \phi_1 \cdot \sigma_{\mathcal{Y}}^2 \hspace{0.08cm}+\hspace{0.08cm} \phi_2\cdot \gamma_{1} \hspace{0.3cm}\Rightarrow\hspace{0.3cm} \gamma_{1} \hspace{0.08cm}=\hspace{0.08cm} \dfrac{\phi_1}{1-\phi_2} \cdot \sigma_{\mathcal{Y}}^2\\$$


$$\gamma_{2} \hspace{0.08cm}=\hspace{0.08cm} \phi_1 \gamma_1 \hspace{0.08cm}+\hspace{0.08cm} \phi_2\cdot \gamma_{0} \hspace{0.08cm}=\hspace{0.08cm}  \phi_1\cdot\dfrac{\phi_1}{1-\phi_2} \cdot \sigma_{\mathcal{Y}}^2 \hspace{0.08cm}+\hspace{0.08cm} \phi_2\cdot \sigma_{\mathcal{Y}}^2 \hspace{0.08cm}=\hspace{0.08cm}  \left( \dfrac{\phi_1^2}{1-\phi_2} \hspace{0.08cm}+\hspace{0.08cm} \phi_2 \right)\cdot \sigma_{\mathcal{Y}}^2\\$$
...
$$\rho_{2} \hspace{0.08cm}=\hspace{0.08cm} \dfrac{\phi_1^2}{1-\phi_2} \hspace{0.08cm}+\hspace{0.08cm} \phi_2  \\[1cm]$$
...
$$\rho_{h} \hspace{0.08cm}=\hspace{0.08cm} \dfrac{\hspace{0.08cm}\gamma_{h} \hspace{0.08cm}}{\sigma_{\mathcal{Y}}^2}$$
...
$\hspace{0.25cm}$ The weak stationarity condition is that $\hspace{0.08cm}| \hspace{0.08cm}G_1\hspace{0.08cm} | < 1\hspace{0.1cm}$ and $\hspace{0.1cm}| \hspace{0.08cm}G_2\hspace{0.08cm} | < 1\hspace{0.1cm}. \\$


$\hspace{0.25cm}$ Where $\hspace{0.08cm}G_1\hspace{0.08cm}$ and $\hspace{0.08cm}G_2\hspace{0.08cm}$ are the roots of the following equation, called **characteristic equation**: $\\[0.3cm]$
...
$\hspace{0.25cm}$ Using an $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ model, the estimation of the past (observed) values $\hspace{0.1cm}y_t \hspace{0.2cm},\hspace{0.2cm} t=1,...,n \hspace{0.15cm}$ of the process is done using the following equation: $\\[0.3cm]$

$$\widehat{y}_t \hspace{0.1cm}=\hspace{0.1cm} \widehat{\phi}_0 \hspace{0.1cm}+\hspace{0.1cm} \widehat{\phi}_1 \cdot y_{t-1} 
\hspace{0.1cm}+\hspace{0.1cm} \widehat{\phi}_2 \cdot y_{t-2} \hspace{0.35cm},\hspace{0.35cm} t = 3,4,\dots , n$$
...
- As it was seen, the fundamental equation of an $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ model is: $\\[0.5cm]$
    ...
    $$\mathcal{Y}_t \hspace{0.1cm}=\hspace{0.1cm} \phi_0 \hspace{0.08cm}+\hspace{0.08cm}  \phi_1 \cdot \mathcal{Y}_{t-1}\hspace{0.08cm}+\hspace{0.08cm}  \phi_2 \cdot \mathcal{Y}_{t-2}\hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t \hspace{0.3cm} , \hspace{0.3cm} t=3,\dots , n\\$$
...
- Then, one has the following:
    ...
    $$\mathcal{Y}_t \hspace{0.15cm}|\hspace{0.15cm} \mathcal{Y}_{t-1} = y_{t-1} \hspace{0.06cm},\hspace{0.06cm} \mathcal{Y}_{t-2} = y_{t-2} \hspace{0.15cm} \sim \hspace{0.15cm}\frac{1}{\sqrt{2\pi\sigma^2}} \cdot \exp\left(-\frac{(y_t - ( \phi_0 +  \phi_1 \cdot y_{t-1} +\phi_2 \cdot y_{t-2}))^2}{2\sigma^2}\right) \\[1.5cm]$$

- Therefore, the likelihood function of $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ model is:

    $$\mathcal{L}(\phi_0,\phi_1, \phi_2, \sigma^2) \hspace{0.09cm}=\hspace{0.09cm} f_{\hspace{0.1cm} \bigl(\hspace{0.06cm} \mathcal{Y}_t \hspace{0.1cm}|\hspace{0.1cm} \mathcal{Y}_{t-1}=y_{t-1}\hspace{0.06cm},\hspace{0.06cm} \mathcal{Y}_{t-2}=y_{t-2} \hspace{0.15cm}:\hspace{0.15cm} t=3,...,n \hspace{0.06cm} \bigr) } \hspace{0.08cm} (y_{3},...,y_n) \hspace{0.1cm}=\hspace{0.1cm} \prod_{t=3}^n\hspace{0.1cm}  f_{\hspace{0.06cm}\mathcal{Y}_t \hspace{0.08cm}|\hspace{0.08cm} \mathcal{Y}_{t-1}=y_{t-1}}(y_t) \hspace{0.1cm}=\hspace{0.1cm} \prod_{t=3}^n \hspace{0.1cm}  \frac{1}{\sqrt{2\pi\sigma^2}} \cdot \exp\left(-\frac{(y_t - ( \phi_0 +  \phi_1 \cdot y_{t-1} +\phi_2 \cdot y_{t-2}))^2}{2\sigma^2}\right)\\[0.7cm]$$



    Where:

    $$f_{\hspace{0.1cm} \bigl(\hspace{0.06cm} \mathcal{Y}_t \hspace{0.1cm}|\hspace{0.1cm} \mathcal{Y}_{t-1}=y_{t-1}\hspace{0.06cm},\hspace{0.06cm} \mathcal{Y}_{t-2}=y_{t-2} \hspace{0.15cm}:\hspace{0.15cm} t=3,...,n \hspace{0.06cm} \bigr) } \hspace{0.08cm} (y_{3},...,y_n) \hspace{0.15cm}=\hspace{0.15cm}    f_{\hspace{0.1cm}\mathcal{Y}_3 \hspace{0.1cm}|\hspace{0.1cm} \mathcal{Y}_{2}=y_{2}\hspace{0.06cm},\hspace{0.06cm} \mathcal{Y}_{1}=y_{1} \hspace{0.1cm},... ,\hspace{0.1cm} \mathcal{Y}_n \hspace{0.1cm}|\hspace{0.1cm} \mathcal{Y}_{n-1}=y_{n-1}\hspace{0.06cm},\hspace{0.06cm}\mathcal{Y}_{n-2}=y_{n-2}}\hspace{0.08cm} (y_{3},...,y_n) \\[1.25cm]$$




- The log-likelihood function is: $\\[0.4cm]$
...
- The $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ parameters estimation is made as follow:
$\\[0.5cm]$


    $$\widehat{\phi}_0, \widehat{\phi}_1, \widehat{\phi}_2,  \widehat{\sigma}^2 \hspace{0.15cm} =\hspace{0.15cm}  arg \hspace{0.15cm}  \underset{\phi_0, \phi_1,\phi_2, \sigma^2}{Max} \hspace{0.13cm}  ln\left( \hspace{0.07cm}  \mathcal{L}(\phi_0,\phi_1,\phi_2, \sigma^2) \hspace{0.07cm} \right)\\[0.6cm]$$
...
As it was seen, the fundamental equation of an $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ model is: $\\[0.44cm]$
...
\hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t \hspace{0.4cm} , \hspace{0.4cm} t=3,\dots , n\\$$



- Assuming that $\hspace{0.1cm}\mathcal{Y}_t = y_t\hspace{0.1cm} , \hspace{0.1cm}\mathcal{Y}_{t-1}=y_{t-1}\hspace{0.1cm}$ and $\hspace{0.1cm}\mathcal{Y}_{t-2}=y_{t-2}\hspace{0.15cm}$ , the $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ equation is: $\\[0.44cm]$

    $$y_t \hspace{0.08cm}=\hspace{0.08cm} \phi_0 \hspace{0.08cm}+\hspace{0.08cm} \phi_1 \cdot y_{t-1} \hspace{0.08cm}+\hspace{0.08cm} \phi_2 \cdot y_{t-2} \hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t \hspace{0.4cm} , \hspace{0.4cm} t=2,\dots , n \\$$


- So, the non estimated model residuals are: $\\[0.35cm]$

    $$\varepsilon_t \hspace{0.1cm}=\hspace{0.1cm} y_t \hspace{0.08cm}-\hspace{0.08cm} (\phi_0 \hspace{0.08cm}+\hspace{0.08cm} \phi_1 \cdot y_{t-1}\hspace{0.08cm}+\hspace{0.08cm} \phi_2 \cdot y_{t-2}) \hspace{0.4cm} , \hspace{0.4cm} t=2,\dots , n \\$$ 

     


    - With OLS method, $\hspace{0.08cm}AR(2)\hspace{0.08cm}$ parameters estimation is made as follow:
$\\[0.3cm]$


    $$\widehat{\phi}_0, \widehat{\phi}_1 \hspace{0.2cm} =\hspace{0.2cm}  arg \hspace{0.25cm}  \underset{\phi_0, \phi_1}{Min} \hspace{0.2cm}  \sum_{t=2}^n\hspace{0.08cm} \varepsilon_t^2 \hspace{0.2cm} =\hspace{0.2cm}  arg \hspace{0.25cm}  \underset{\phi_0, \phi_1}{Min} \hspace{0.2cm} \sum_{t=2}^n \hspace{0.1cm} \left( \hspace{0.07cm} y_t \hspace{0.08cm}-\hspace{0.08cm} (\phi_0 + \phi_1\cdot y_{t-1}+\phi_2\cdot y_{t-2}) \hspace{0.07cm}\right)^2$$
...
$\hspace{0.25cm}$ The $\hspace{0.08cm}p$-order autoregressive process $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ for the process $\hspace{0.08cm}\mathcal{Y}\hspace{0.08cm}$ is defined as: $\\[0.35cm]$
...
Taking into account the following matrix: $\\[0.35cm]$
...
$\hspace{0.25cm}$ We can express an $\hspace{0.09cm}AR(p)\hspace{0.09cm}$ process as follow: $\\[0.35cm]$
...
$\hspace{0.25cm}$ We can express $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ process using the lag operator as follows: $\\[0.4cm]$
...
$\hspace{0.25cm}$ Assuming that $\hspace{0.07cm}AR(p)\hspace{0.07cm}$ process is weakly stationary in mean we have the following: $\\[0.4cm]$
...
$\hspace{0.25cm}$ Where: $\hspace{0.14cm}\mu_t \hspace{0.08cm}=\hspace{0.08cm} E[\mathcal{Y}_t]\\$
...
$\hspace{0.2cm}\mu_{\mathcal{Y}}\hspace{0.1cm}$ is finite only if $\hspace{0.1cm}1-\phi_1-\phi_2- \dots - \phi_p \neq 0\hspace{0.08cm}$.
...
$\hspace{0.25cm}$ Assuming that $\hspace{0.07cm}AR(p)\hspace{0.07cm}$ process is weakly stationary in variance we have the following: $\\[0.4cm]$
...
$\hspace{0.2cm}\sigma^2_t \hspace{0.08cm}=\hspace{0.08cm} Var(\mathcal{Y}_t)\\$
...
$\hspace{0.25cm}$ The **Yule-Walker equations** for an $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ process are a system of $\hspace{0.08cm}p\hspace{0.08cm}$ linear equations that relate the autocovariances at lags $\hspace{0.08cm}1, 2, ..., p\hspace{0.08cm}$ to the coefficients $\hspace{0.08cm}\phi_1, \phi_2, \ldots, \phi_p\hspace{0.08cm}$. 

$\hspace{0.25cm}$ These equations are:
...
There isn't a general expression for $\hspace{0.1cm}\rho_{h}\hspace{0.1cm}$ for any $\hspace{0.1cm}h=0,\pm 1, \pm 2,\dots\hspace{0.08cm}$
...
$\hspace{0.25cm}$ The **Yule-Walker equations** for an $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ process are a system of $\hspace{0.08cm}p\hspace{0.08cm}$ linear equations that relate the autocorrelation at lags $\hspace{0.1cm}1, 2, ..., p\hspace{0.1cm}$ to the coefficients $\hspace{0.1cm}\phi_1, \phi_2, \ldots, \phi_p\hspace{0.08cm}$. 
...
### Sample Estimation of Autocorrelations

The sample estimation of $\hspace{0.1cm}\rho_h = Corr(\mathcal{Y}_t , \mathcal{Y}_{t-h}) = \dfrac{\hspace{0.1cm}\gamma_{h}\hspace{0.1cm}}{\sigma_{\mathcal{Y}}^2} \hspace{0.1cm}$ in a weakly stationary process can be done with the following formula:

$$
\widehat{\rho}_h \hspace{0.09cm} =\hspace{0.09cm} \dfrac{\hspace{0.09cm}\widehat{\gamma}_k \hspace{0.09cm}}{\sigma_{\mathcal{Y}}^2}
$$
...
$\hspace{0.25cm}$ The weak stationarity condition is that $\hspace{0.08cm}| \hspace{0.08cm}G_i\hspace{0.08cm} | \hspace{0.08cm} < \hspace{0.08cm} 1\hspace{0.2cm} ,\hspace{0.2cm}  \forall i =1,\dots ,p\hspace{0.1cm} \\$


$\hspace{0.25cm}$ Where: $\hspace{0.25cm} G_i \hspace{0.2cm} ,\hspace{0.2cm}  \forall \hspace{0.06cm} i =1,\dots ,p\hspace{0.25cm}$ are the roots of the following equation, called **characteristic equation**: $\\[0.35cm]$
...
$\hspace{0.25cm}$ Using an $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ model, the estimation of the past (observed) values $\hspace{0.1cm}y_t \hspace{0.1cm},\hspace{0.1cm} t=1,...,n$ of the process is done using the following equation: $\\[0.3cm]$

$$\widehat{y}_t \hspace{0.1cm}=\hspace{0.1cm} \widehat{\phi}_0 \hspace{0.1cm}+\hspace{0.1cm} \widehat{\phi}_1 \cdot y_{t-1} 
\hspace{0.1cm}+\hspace{0.1cm} \widehat{\phi}_2 \cdot y_{t-2} \hspace{0.1cm}+\hspace{0.1cm} \dots \hspace{0.1cm}+\hspace{0.1cm} \widehat{\phi}_p \cdot y_{t-p} \hspace{0.1cm}=\hspace{0.1cm} \phi_0 \hspace{0.1cm}+\hspace{0.1cm} \sum_{h=1}^p \widehat{\phi}_h \cdot y_{t-h}  \hspace{0.4cm},\hspace{0.4cm} t \hspace{0.1cm}=\hspace{0.1cm} p+1,\dots , n\\[0.4cm]$$
...
If the avaible data of the process is given by the time series $\hspace{0.07cm}Y_t = \left( y_1, y_2, ...,y_n \right)^t \hspace{0.12cm}$ , then, for $\hspace{0.07cm}t\hspace{0.07cm}=\hspace{0.07cm}p+1,...,n,\hspace{0.15cm}$ the value $\hspace{0.15cm}\widehat{y}_t\hspace{0.07cm}$ is an estimation of the observed value $\hspace{0.08cm}y_t\hspace{0.08cm}$ of the process $\hspace{0.07cm}\mathcal{Y}\hspace{0.07cm}$. 
...
$\hspace{0.25cm}$ Using an $\hspace{0.07cm}AR(p)\hspace{0.07cm}$ model we can forecast future values $\hspace{0.1cm}y_{n+k} \hspace{0.15cm},\hspace{0.15cm} k=1,2,\dots \hspace{0.15cm}$ of the process using the following equations: $\\[0.3cm]$
...
- In general, for $\hspace{0.1cm} k=1,2,3,\dots\hspace{0.13cm}$ , we have the following prediction equation: $\\[0.35cm]$
    ...
    Where, it must be assumed that $\hspace{0.11cm}n+k \hspace{0.05cm}> \hspace{0.05cm}p\hspace{0.09cm}$.
...
- As it was seen, the fundamental equation of an $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ model is: $\\[0.35cm]$
    ...
    $$\mathcal{Y}_t \hspace{0.1cm}=\hspace{0.1cm} \phi_0 \hspace{0.08cm}+\hspace{0.08cm} \sum_{h=1}^p \hspace{0.08cm}  \phi_h \cdot \mathcal{Y}_{t-h}\hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t \hspace{0.3cm} , \hspace{0.3cm} t=p+1,\dots , n\\$$
...
- Since the error term $\hspace{0.07cm}\varepsilon_t\hspace{0.07cm}$ is Gaussian, namely, $\hspace{0.07cm}\varepsilon_t \sim N(0,\sigma^2)\hspace{0.07cm}$, it turns out that: $\\[0.5cm]$
     ...
     $$\mathcal{Y}_t \hspace{0.2cm}|\hspace{0.2cm} \mathcal{Y}_{t-1} = y_{t-1},\dots \hspace{0.07cm},\hspace{0.07cm} \mathcal{Y}_{t-p} = y_{t-p} \hspace{0.2cm} = \hspace{0.2cm} \phi_0 \hspace{0.08cm}+\hspace{0.08cm}  \sum_{h=1}^p \phi_h \cdot y_{t-h} \hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t \hspace{0.2cm}\sim\hspace{0.2cm} N\left( \hspace{0.07cm} \phi_0 + \sum_{h=1}^p \phi_h \cdot y_{t-h} \hspace{0.13cm} ,\hspace{0.13cm} \sigma^2 \hspace{0.07cm} \right) \hspace{0.35cm} , \hspace{0.35cm} t\hspace{0.09cm}=\hspace{0.09cm}p+1,\dots , n \\[1.5cm]$$ 
...
- Therefore, the likelihood function of $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ model is: $\\[0.5cm]$
    ...
    $$\mathcal{L}(\phi_0,\phi_1,..., \phi_p, \sigma^2) \hspace{0.09cm}=\hspace{0.09cm} f_{\hspace{0.09cm}\bigl(\hspace{0.08cm}\mathcal{Y}_t \hspace{0.15cm}|\hspace{0.15cm} \mathcal{Y}_{t-1}\hspace{0.05cm}=\hspace{0.05cm}y_{t-1}\hspace{0.06cm},...,\hspace{0.06cm}\mathcal{Y}_{t-p}\hspace{0.05cm}=\hspace{0.05cm}y_{t-p} \hspace{0.12cm} : \hspace{0.12cm} t\hspace{0.07cm}=\hspace{0.07cm}p+1,...,n \hspace{0.08cm}\bigr)}\hspace{0.06cm} (y_{p+1},...,y_n)     \hspace{0.1cm}=\hspace{0.1cm} \prod_{t=p+1}^n \hspace{0.1cm}  \frac{1}{\sqrt{2\pi\sigma^2}} \cdot \exp\left(-\frac{(y_t - ( \phi_0 + \sum_{h=1}^p \phi_h \cdot y_{t-h}))^2}{2\sigma^2}\right)\\[1.5cm]$$

 
   
    Where:

    $$f_{\hspace{0.09cm}\bigl(\hspace{0.08cm}\mathcal{Y}_t \hspace{0.15cm}|\hspace{0.15cm} \mathcal{Y}_{t-1}\hspace{0.05cm}=\hspace{0.05cm}y_{t-1}\hspace{0.06cm},...,\hspace{0.06cm}\mathcal{Y}_{t-p}\hspace{0.05cm}=\hspace{0.05cm}y_{t-p} \hspace{0.15cm} : \hspace{0.15cm} t\hspace{0.05cm}=\hspace{0.05cm}p+1,...,n \hspace{0.08cm}\bigr)}\hspace{0.06cm} (y_{p+1},...,y_n)  \hspace{0.09cm} = \hspace{0.09cm} f_{\hspace{0.08cm}\mathcal{Y}_{p+1} \hspace{0.15cm}|\hspace{0.15cm} \mathcal{Y}_{p}\hspace{0.05cm}=\hspace{0.05cm}y_{p}\hspace{0.06cm},...,\hspace{0.06cm} \mathcal{Y}_{1}\hspace{0.05cm}=\hspace{0.05cm}y_{1} \hspace{0.1cm} , \dots , \hspace{0.1cm} \mathcal{Y}_{n} \hspace{0.15cm}|\hspace{0.15cm} \mathcal{Y}_{n-1}\hspace{0.05cm}=\hspace{0.05cm}y_{n-1}\hspace{0.06cm},...,\hspace{0.06cm} \mathcal{Y}_{n-p}\hspace{0.05cm}=\hspace{0.05cm}y_{n-p}  } \hspace{0.06cm} (y_{p+1},...,y_n)   \\$$
...
$\\[0.5cm]$
    ...
    $$\widehat{\phi}_0, \widehat{\phi}_1,..., \widehat{\phi}_p,  \widehat{\sigma}^2 \hspace{0.15cm} =\hspace{0.15cm}  arg \hspace{0.15cm}  \underset{\phi_0, \phi_1,...,\phi_p, \sigma^2}{Max} \hspace{0.15cm}  ln\left( \hspace{0.07cm}  \mathcal{L}(\phi_0,\phi_1,...,\phi_p, \sigma^2) \hspace{0.07cm} \right)$$


    This problem can be solved using numeric optimization methods, such as Newton-Raphson or descendent gradient. 
...
- As it was seen, the fundamental equation of an $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ model is:

    $$\mathcal{Y}_t \hspace{0.08cm}=\hspace{0.08cm} \phi_0 \hspace{0.08cm}+\hspace{0.08cm} \sum_{h=1}^p \hspace{0.05cm} \phi_h \cdot  \mathcal{Y}_{t-h} \hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t \hspace{0.4cm} , \hspace{0.4cm} t\hspace{0.1cm}=\hspace{0.1cm} p+1 ,..., n \\[0.45cm]$$


- Assuming that $\hspace{0.12cm}\mathcal{Y}_t = y_t \hspace{0.1cm},\hspace{0.1cm} \mathcal{Y}_{t-1} = y_{t-1} \hspace{0.1cm},\hspace{0.1cm} \dots \hspace{0.1cm},\hspace{0.1cm} \mathcal{Y}_{t-p} = y_{t-p}\hspace{0.15cm}$, the $\hspace{0.07cm}AR(p)\hspace{0.07cm}$ equation can be expressed as:

    $$y_t \hspace{0.08cm}=\hspace{0.08cm} \phi_0 \hspace{0.08cm}+\hspace{0.08cm} \sum_{h=1}^p \hspace{0.05cm} \phi_h \cdot  y_{t-h} \hspace{0.08cm}+\hspace{0.08cm} \varepsilon_t  \hspace{0.4cm} , \hspace{0.4cm} t\hspace{0.1cm}=\hspace{0.1cm} p+1 ,..., n \\[0.45cm]$$
...
$\\[0.5cm]$
    ...
    $$\widehat{\phi}_0, \widehat{\phi}_1,..., \widehat{\phi}_p \hspace{0.15cm} =\hspace{0.15cm}  arg \hspace{0.13cm}  \underset{\phi_0, \phi_1,..., \phi_p}{Min} \hspace{0.15cm}  \sum_{t=p+1}^n \hspace{0.08cm}e_t^2 \hspace{0.15cm}=\hspace{0.15cm} arg \hspace{0.13cm}  \underset{\phi_0, \phi_1,..., \phi_p}{Min} \hspace{0.15cm} \sum_{t=p+1}^n \hspace{0.08cm} \left(y_t - (\phi_0 + \sum_{h=1}^n \phi_h \cdot y_{t-h} ) \right)^2$$
...
But in this case, there is a closed-form solution for the ordinary least squares (OLS) method to estimate the coefficients of an $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ model. The OLS method seeks to minimize the sum of squared residuals between the predicted values of the $\hspace{0.08cm}AR(p)\hspace{0.08cm}$ model and the observed values.


Taking into account the following matrix: $\\[0.4cm]$

$$
\mathbf{Y} \hspace{0.08cm}=\hspace{0.08cm} \begin{pmatrix}
y_{p+1} \\
y_{p+2}\\
... \\
y_{n}\end{pmatrix} \hspace{0.3cm}, \hspace{0.3cm} \mathbf{X} \hspace{0.08cm}=\hspace{0.08cm} \begin{pmatrix}
1 & y_p & y_{p-1} & ... & y_{1} \\
1 & y_{p+1} & y_{p}  & ... & y_{2} \\
... \\
1 & y_{n-1} & y_{n-2} & ... & y_{n-p} \\
\end{pmatrix}
  \hspace{0.3cm}, \hspace{0.3cm} \boldsymbol{\phi} \hspace{0.08cm}=\hspace{0.08cm} \begin{pmatrix}
\phi_0 \\
\phi_1 \\
... \\
\phi_p 
...
$$\widehat{\boldsymbol{\phi}} \hspace{0.15cm} =\hspace{0.15cm}  arg \hspace{0.15cm}  \underset{\boldsymbol{\phi}}{Min} \hspace{0.15cm}   (\mathbf{Y} - \mathbf{X}\cdot \boldsymbol{\phi})^t \cdot (\mathbf{Y} - \mathbf{X}\cdot \boldsymbol{\phi})  \\[1cm]$$
...
$$\hat{\boldsymbol{\phi}}\hspace{0.15cm}=\hspace{0.15cm}(\mathbf{X}^t \cdot \mathbf{X})^{-1} \cdot \mathbf{X}^t \cdot \mathbf{Y}$$
