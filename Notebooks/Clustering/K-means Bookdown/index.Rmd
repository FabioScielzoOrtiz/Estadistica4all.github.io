...
$\hspace{0.2cm}$ **1) Initial clusters definition.**
...
$\hspace{0.2cm}$ **2) Computing the centroids of the initial clusters.**
...
$\hspace{0.2cm}$ **3) Computing the sum of intra-clusters variances.**
...
$\hspace{0.2cm}$ **4) Reassignment of observations to clusters.**
...
$\hspace{0.2cm}$ **5) Computing the centroids of the new clusters.**
...
$\hspace{0.2cm}$ **6) Computing the sum of the intra-clusters variances for the new clusters.**
...
$\hspace{0.2cm}$ **7) Iterate steps 4) , 5) and 6).**
...
$\hspace{0.2cm}$ **8) Selecting the optimal clusters configuration**
