...
- The goal is tio predict the response variable   $\hspace{0.02cm}\mathcal{Y}\hspace{0.02cm}$ for any observations vector of the predictors, using only the available sample information about the predictors.
