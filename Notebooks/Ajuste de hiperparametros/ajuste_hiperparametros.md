...
- Se selecciona el vector de hiper-parámetros $\hspace{0.1cm}s=(s_1,...,s_r) \in S\hspace{0.15cm}$ con el que se obtiene un mejor valor de la métrica de validacion. Si la metrica es de *error*, se selecciona el $\hspace{0.1cm}s\hspace{0.1cm}$ con el que se obtiene *menor* valor de la métrica. Si la métrica es de *acierto*, se seleciona el $\hspace{0.1cm}s\hspace{0.1cm}$ con el que se obtiene *mayor* valor de la metrica. $\\[0.5cm]$

    - Si, por ejemplo, tuvieramos un modelo de regresión y la métrica usado fuera el $\hspace{0.07cm}ECM\hspace{0.07cm}$, que es una métrica de error, entonces el vector de hiper-parámetros seleccionado sería $\hspace{0.1cm}s^*\hspace{0.1cm}$, donde:
