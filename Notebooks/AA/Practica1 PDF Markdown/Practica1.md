 ...
 **Propuesta *simplificada* de algoritmo para la resolucion del problema**  

\vspace{0.2cm}

El siguiente algoritmo es una propuesta simplificada para "resolver" el problema planteado anteriormente. Realmente esta propuesta no resuelve el prblema, ya que es una aproximación muy limitada, pero su simplicidad nos permitirá programarla en `Python` desde cero, lo que es un  ejemplo útil de como programar un algoritmo relativamente complejo (en comparación con otros mas simples como KNN o regresión lineal).


Se fundamenta en la propuesta anterior, la diferencia es que es mucho mas simple, y esto es asi para que no sea excesivamente compleja de programar.

Las principales diferencias son:

Solo se van a considerar los problemas asociados a las iteraciones 1,2,3 y 4 , por lo que a lo sumo se podria generar un arbol con esas cuatro iteraciones usando este algoritmo, es decir, un arbol muy pequeño en cualquier caso.

El criterio de parada es distinto, el cual favorece un tamaño del arbol aun si cabe mas reducido. 
...
\begin{gather*}
\underset{R_{11}  ,  R_{21}}  {Min} \hspace{0.15cm} \left(\hspace{0.1cm} TEC_1 = TEC(R_{11}) + TEC(R_{21})  \hspace{0.1cm}\right) 
\end{gather*}
...
\begin{gather*}
\underset{R_{11}  ,  R_{21}}  {Min} \hspace{0.15cm} \left(\hspace{0.1cm} G_1 = G_{R_{11}} + G_{R_{21}}  \hspace{0.1cm}\right)  
\end{gather*}
...
Nuevo criterio de parada: (diferente al del algoritmo clásico)
...
\begin{gather*}
\underset{R_{12}  ,  R_{22}}  {Min} \hspace{0.15cm}  \Biggl\{ \hspace{0.1cm} TEC_2 = TEC(R_{12})  +  TEC(R_{22}) ) \hspace{0.1cm} \Biggl\}   \hspace{0.1cm} 
\end{gather*}
...
\begin{gather*}
\underset{R_{12}  ,  R_{22}, }  {Min} \hspace{0.15cm} \Biggl\{  \hspace{0.1cm} G_1 = G_{R_{12}} + G_{R_{22} }  \hspace{0.1cm} \Biggl\}    \hspace{0.1cm}   
\end{gather*}
...
$$ \underset{R_1,..,R_m}{Min}  \hspace{0.12cm}  \sum_{h=1}^{m} \hspace{0.1cm} G_{R_{h}} + \alpha \cdot m $$
