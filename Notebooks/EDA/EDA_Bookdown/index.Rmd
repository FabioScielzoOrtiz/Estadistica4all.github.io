...
description: |
  This is an article about exploratory data analysis, with applications in Python.
link-citations: yes
...
$\hspace{1cm}$ Scielzo Ortiz, Fabio. (2023). Exploratory Data Analysis. 

- ***It's recommended to open the article on a computer, tablet or on a phone using the desktop version.***
...
Exploratory data analysis (EDA) refers to the statistical description and analysis of a data-set. We also consider  data preprocessing  as part of the exploratory data analysis.

Next, we are going to propose a methodology to carry out an EDA, using `Python` as programming lenguage.

We are also going to develop an EDA app using `Streamlit`.
...
|----:|:-----------|:-----------------------------------------|:------|:-----------------------------------------------------------------------------------------------------------------------|-------------|------------------|--------:|:--------------------------------------------------|:-----------------------|--------:|:-----------|-----------:|-----------:|----------------:|-----------:|
|   0 | ts300399   | Five Came Back: The Reference Films       | SHOW  | This collection includes 12 World War II-era propaganda films directed by Frank Capra, John Huston and other Hollywood greats. | 1945.0       | TV-MA             |      51 | ['documentation']                                 | ['US']                 |       1 | NaN        |        NaN |        NaN |           0.600 |        NaN |
|   1 | tm84618    | Taxi Driver                              | MOVIE | A mentally unstable Vietnam War veteran works as a nighttime taxi driver in New York City where the perceived decadence and sleaze feeds his urge for violent action.     | 1976.0       | R                 |     114 | ['drama', 'crime']                               | ['US']                 |     NaN | tt0075314  |        8.2 |   808582.0 |          40.965 |      8.179 |
|   2 | tm154986   | Deliverance                              | MOVIE | Intent on seeing the Cahulawassee River before it's dammed and turned into a lake, outdoor fanatic Lewis Medlock takes his friends on a river-rafting trip they'll never forget.   | 1972.0       | R                 |     109 | ['drama', 'action', 'thriller', 'european']      | ['US']                 |     NaN | tt0068473  |        7.7 |   107673.0 |          10.010 |      7.300 |
...
|   4 | tm120801   | The Dirty Dozen                          | MOVIE | A US Army Major is assigned a dozen convicted murderers to train and lead them into a mass assassination mission of German officers in World War II.                                     | 1967.0       | NaN               |     150 | ['war', 'action']                                | ['GB', 'US']           |     NaN | tt0061578  |        7.7 |    72662.0 |          20.398 |      7.600 |
...
`info()` method gives us the column names, the number of the non null values in each column and column type.
