---
title: 'Los problemas de clasificación y regresión'
...
Podríamos decir que la ciencia de datos es la ciencia que trata de resolver problemas prácticos usando datos como materia prima y técnicas estadísticas y tecnologías informaticas como herramientas.
...
Donde: $\hspace{0.1cm}y_i = NA\hspace{0.1cm}$ , para muchos $\hspace{0.1cm}i\in \lbrace 1,...,n\rbrace$
