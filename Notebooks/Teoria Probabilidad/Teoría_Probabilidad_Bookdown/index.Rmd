...
La probabilidad condicionada entre variables aleatorias discretas se define como sigue: $\\$

$$P(\mathcal{X}=x \hspace{0.08cm}|\hspace{0.08cm} \mathcal{Y}=y) \hspace{0.1cm}=\hspace{0.1cm} \dfrac{\hspace{0.08cm}P(\mathcal{X}=x \hspace{0.08cm},\hspace{0.08cm} \mathcal{Y}=y)\hspace{0.08cm}}{P(\mathcal{Y}=y)} \\$$


## Propiedades

- $P(\mathcal{X}\in A \hspace{0.08cm}|\hspace{0.08cm} \mathcal{Y}=y) \hspace{0.1cm} = \hspace{0.1cm} \sum_{x\in A} P(\mathcal{X}=x \hspace{0.08cm}|\hspace{0.08cm} \mathcal{Y}=y)$  
...
La probabilidad condicionada entre variables aleatorias continuas se define como sigue:
...
- Teniendo en consideración el problema anterior, se esquiva del siguiente modo:
    ...
    Donde ahora $\hspace{0.1cm}P(\mathcal{Y}\in [y , y+ \delta]) \hspace{0.08cm}>\hspace{0.08cm} 0\hspace{0.08cm}$. $\\$ 
...
$$\forall \hspace{0.08cm} A,B \subset \mathbb{R} \hspace{0.2cm},\hspace{0.2cm} \int_{x\in A} \int_{y \in B} \hspace{0.08cm} f_{\mathcal{X},\mathcal{Y}}(x,y) \cdot dy \cdot dx \hspace{0.08cm}=\hspace{0.08cm} \int_{x\in A} \hspace{0.08cm} f_{\mathcal{X}}(x)  \cdot dx \cdot \int_{y \in B} f_{\mathcal{Y}}(y) \cdot dy$$
...
$$\text{Si} \hspace{0.25cm}\exists\hspace{0.1cm} h,g \hspace{0.08cm}:\hspace{0.08cm} \mathbb{R} \rightarrow \mathbb{R}\hspace{0.15cm} , \hspace{0.15cm} \forall \hspace{0.08cm} x,y \in \mathbb{R} \hspace{0.15cm},\hspace{0.15cm} f_{\mathcal{X},\mathcal{Y}}(x,y) \hspace{0.08cm}=\hspace{0.08cm} g(x)\cdot h(y) \hspace{0.24cm}
\Rightarrow\hspace{0.24cm} \mathcal{X} \perp \mathcal{Y}.$$
