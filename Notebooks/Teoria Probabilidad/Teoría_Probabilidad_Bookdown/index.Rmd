...
- $\mathcal{X}_1,...,\mathcal{X}_n \hspace{0.05cm}$ es una muestra aleatoria simple (m.a.s.) de tamaño $\hspace{0.03cm}n\hspace{0.03cm}$ de $\hspace{0.04cm}\mathcal{X}$ $\hspace{0.3cm}\Leftrightarrow\hspace{0.3cm}$ $(\mathcal{X}_1,...,\mathcal{X}_n) \underset{i.i.d.}{\sim} D(\cdot)$ $\\$
...
# Algunos teoremas relevantes en inferencia estadística
 
## Teorema de esperanza-varianza de la media muestral

 

 Si tenemos una v.a. $\hspace{0.03cm}\mathcal{X}\hspace{0.03cm}$ y una m.a.s $\hspace{0.03cm}\mathcal{X}_1,...,\mathcal{X}_n\hspace{0.03cm}$ de $\hspace{0.1cm}\mathcal{X}\hspace{0.03cm}$ , entonces: $\\$
...
# Algunas desigualdades relevantes 
...
Se cumple la siguiente desigualdad, conocida como desigualdad de Markov: $\\$
...
Se cumple la siguiente desigualdad, conocida como desigualdad de Chebychev: $\\$
...
$h(\mathcal{X}_1,...,\mathcal{X}_n)\hspace{0.13cm} \text{converge en probabilidad a} \hspace{0.12cm}\mathcal{X}$ $\hspace{0.3cm}\Leftrightarrow\hspace{0.3cm}$ $h(\mathcal{X}_1,...,\mathcal{X}_n)\hspace{0.1cm} \underset{p}{\rightarrow} \hspace{0.1cm}\mathcal{X}$
...
## Convergencia en distribución 
 ...
 Dada una v.a. $\hspace{0.03cm}\mathcal{X}\hspace{0.03cm}$, una m.a.s $\hspace{0.03cm}\mathcal{X}_1,...,\mathcal{X}_n\hspace{0.03cm}$ de $\hspace{0.03cm}\mathcal{X}\hspace{0.03cm}$, y una función de la m.a.s $\hspace{0.03cm}h(\mathcal{X}_1,...,\mathcal{X}_n)\hspace{0.03cm}$, donde $\hspace{0.1cm}h \hspace{0.1cm} : \hspace{0.1cm} \text{Im}(\mathcal{X}_1)\hspace{0.05cm}\text{x}\dots \text{x}\hspace{0.05cm}\text{Im}(\mathcal{X}_n) \hspace{0.1cm}\rightarrow\hspace{0.1cm} \mathbb{R}\hspace{0.12cm}$ , entonces: $\\$
...
El momento de orden $\hspace{0.03cm}k\hspace{0.03cm}$ de la variable aleatoria $\hspace{0.03cm}\mathcal{X}\hspace{0.03cm}$ es $\hspace{0.03cm}E\left[\hspace{0.03cm}\mathcal{X}^k\hspace{0.03cm}\right]\hspace{0.08cm}$.
...
- Si tenemos una m.a.s $\hspace{0.1cm}\mathcal{X}_1 ,...,\mathcal{X}_n\hspace{0.1cm}$  de una v.a. $\hspace{0.1cm}\mathcal{X}\hspace{0.1cm}$ , entonces: $\\$
    ...
    - El caso canónico es con $\hspace{0.08cm}k=1\hspace{0.08cm}$ :  $\\$
...
- Si tenemos una v.a. $\hspace{0.03cm}\mathcal{X}\hspace{0.03cm}$ con $\hspace{0.03cm}E[\mathcal{X}] = \mu\hspace{0.2cm}$ y $\hspace{0.2cm}Var(\mathcal{X})=\sigma^2 \neq 0 < \infty\hspace{0.03cm}$ , y también tenemos una m.a.s $\hspace{0.03cm}\mathcal{X}_1,...,\mathcal{X}_n\hspace{0.03cm}$ de $\hspace{0.03cm}\mathcal{X}\hspace{0.03cm}$ , entonces: $\\$
...
- $\text{Si} \hspace{0.3cm}\mathbf{X} = (X_1, X_2, \ldots, X_p)^t  \sim NM_p(\mu, \Sigma)\hspace{0.1cm}\hspace{0.3cm}$ $\Rightarrow$  $\hspace{0.3cm}X_j \sim N(\mu_j , \sigma_j^2)\hspace{0.3cm} ,\hspace{0.25cm} \forall\hspace{0.08cm} j=1,...,p\hspace{0.08cm}$.


- Si $\hspace{0.04cm}\mathbf{X} \sim NM_p(\mu, \Sigma)\hspace{0.04cm}$ , entonces cualquier combinación lineal de las componentes de $\hspace{0.03cm}\mathbf{X}\hspace{0.03cm}$ también sigue una distribución normal multivariante.
...
- $\text{Si} \hspace{0.3cm}\mathbf{X} \sim N_p(\mu, \Sigma)  \hspace{0.3cm} \Rightarrow \hspace{0.3cm} \mathbf{Y} = A\cdot \mathbf{X}+\mathbf{b} \hspace{0.12cm}\sim\hspace{0.12cm} NM_p(A\cdot \mu + \mathbf{b} \hspace{0.11cm},\hspace{0.11cm} A\cdot \Sigma\cdot A^t )$
    ...
    - $\mathbf{b}\hspace{0.1cm}$ es un vector $\hspace{0.11cm}q \times 1\hspace{0.1cm}$.


- La distribución condicional de una parte de $\hspace{0.1cm}\mathbf{X}\hspace{0.1cm}$ dado el resto de las componentes sigue también una distribución normal multivariante.
...
- Jimenez Recaredo, R. (2021). Probabilidad II [Notas de clase]. Universidad Carlos III, Madrid, España. 

- Rincón, L (2014). Introducción a la  probabilidad. Universidad Nacional Autónoma de México.

- Rincón, L (2007). Curso intermedio de probabilidad. Universidad Nacional Autónoma de México. 
